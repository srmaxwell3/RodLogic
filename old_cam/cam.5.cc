...
#define ____ Unkn
  ...
  Props(6,'X',Data,DE,Unkn,Unkn,Inpt,Rset,T,___,E,DIE0,W,____), // DIER
  ...
  Props(6,'X',Data,DS,Unkn,Unkn,Inpt,Rset,T,___,S,DIS0,N,____), // DISR
  ...
  Props(6,'X',Data,DW,Unkn,Unkn,Inpt,Rset,T,___,W,DIW0,E,____), // DIWR
  ...
  Props(6,'X',Data,DN,Unkn,Unkn,Inpt,Rset,T,___,N,DIN0,S,____), // DINR
